...
var CmdCreate = &cobra.Command{
	...
	Example: "scapr create handler user",
...
var CmdCreateService = &cobra.Command{
	...
	Example: "scapr create service user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateRepository = &cobra.Command{
	...
	Example: "scapr create repository user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
var CmdCreateModel = &cobra.Command{
	...
	Example: "scapr create model user",
	Args:    cobra.ExactArgs(1),
	Run:     runCreate,
}
